...
| Microsoft Store for Business           | <https://businessstore.microsoft.com/>{:target="_blank"}                             |		
...
| Yammer Admin              | <https://www.yammer.com/office365/admin>{:target="_blank"}                             |		
...
| Portal Name                            | URL                                                                                      |
| ---------------------------------------|-----------------------------------------------------------------------------------------:|
| Azure DevOps Status                           | <https://status.dev.azure.com/>{:target="_blank"}                 |
...
| PowerApps Unified Interface Transition Portal | <https://runone.powerappsportals.com/>{:target="_blank"}   |
